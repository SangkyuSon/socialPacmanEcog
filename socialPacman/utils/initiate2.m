function opt = initiate2()

opt = [];
opt.rewardRatio = 10;              % won, reward rate per second
opt.timerMax = 20;                 % min, total time of phase3 (foraging) per day

opt.friendlinessChgMax = 0.45;

opt.screenNumber = 1;              % <--for experimenter
...
% initial information
opt.blockLen = 10;
opt.blockRatio = opt.friendlinessChgMax*2/opt.blockLen;
...
opt.dataDir = fullfile(pwd,'data2',opt.subName);
